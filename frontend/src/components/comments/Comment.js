...
const Comment = (props) => {
	...
	let contextButton = props.contextButton !== true ? false : true; // what the fuck? this means default false. unless stated otherwise
			...
			<div className="list-group-item bg-light justify-content-center">
				...
				<div className="list-group-item p-auto  m-auto d-flex justify-content-between align-items-center ">
					...
					{user && user.username === comment.username ? (
						<React.Fragment>
							<button className="btn-sm btn-danger" onClick={() => deleteComment(comment)}>
								Delete
							</button>
						</React.Fragment>
					) : null}
